...
<p align="center"><img src="assets/fig-centroid.png" width="520" alt="The pinned centroid: the human's arrow deposits intent — the substrate is that intent, embodied; sessions couple to it via warm-up and handoff; drift is the excursion of a participant with nothing to pull it back; the pin is authorship, riding the course of the work toward the goal"></p>
