...
\draw[thick,blue!60] (0,-0.78) -- (0,-1.12);
\draw[thick,blue!60] (-0.42,-1.12) -- (0.42,-1.12);
\foreach \x in {-0.42,-0.24,-0.06,0.12,0.30}
  \draw[blue!60] (\x,-1.12) -- (\x+0.14,-1.29);
...
\draw[->,>=stealth,blue!70,thick] (2.55,0.85) to[bend left=18] (0.90,0.24);
\node[font=\scriptsize,blue!75,anchor=south] at (1.90,0.22) {warm-up};
\end{tikzpicture}
