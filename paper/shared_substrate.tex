...
\textbf{Shared Substrate}: the discipline of forming,
maintaining, and cascading hierarchical external representations
across the manifestation trajectory of a project, made explicit
here in response to the demands of multi-session AI
collaboration. The organising image is the
...
writing of it. Books, lab notebooks,
scientific notation, version control, architectural decision
records: each generation finds apparatus for stabilising thought
across time and distributing it across minds, and some such
apparatus, in one form or another, accompanies every complex
project worth sustaining.
...
The project began as a chat: a description of the
...
flat, around three and a half thousand words, a
...
That KB raised ten Open Questions about scope. The operator
decided those OQs in a single working session; the
...
work without drift, and the work could resume after a break
...
a legacy low-latency Java process --- a
component that had accreted responsibilities for years, did too
much, and had become hard to evolve --- was replaced by a new implementation
...
The discipline articulated in this paper long predates it;
collaboration with current-generation AI agents is
its most recent and most demanding instance --- not its origin. The
