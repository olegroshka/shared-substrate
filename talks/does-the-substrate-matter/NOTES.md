...
| 2 · Frame + corpus intro + three exhibits | 4–9 | 9 | 6 (corpus slide never cut — it is what makes the rest legible; A1 alone can carry the exhibits) |
| 3 · Four practices | 10–25 | 12 | 8 (3.3 is the spine; 3.1 can be one sentence over the figure) |
| 4 · Research examined | 26–34 | 8 | 5 (negatives 1+4 spoken from one slide, corrections slide never cut) |
| 5 · Interactive + close | 35–38 | 5+ | elastic — this is the buffer |
...
| §2 (slide 9) | "how did you measure that?" body language, engineers leaning in | **M-C** (session-log deep dive) after the core arc, or a 60-second verbal version now: three log stores, 1,061 turns, hand-labelled before the classifier existed |
| §3.2 (slide 14, the probe negative) | interest in the probe design ("how do you probe confabulation?") | **M-D** — the pre-registration story plays well told as narrative: frozen by commit, 3 slots voided against my own hypothesis |
| §3.3 (slide 17, the null) | the null lands well / someone says "refreshing" | **M-B** war story 3 — one session, two defects, in the 22/24 project; it deepens the null instead of defending it |
| §3.4 (slide 24, the rework contrast) | "isn't that rework number confounded?" asked *with interest* rather than challenge | **M-E** — show the full table with the † footnotes; the honesty of the 14-day-window restriction converts skeptics |
| §4 (slide 34, the confounds ledger) | room still listening at the confounds ledger | **M-A** then **M-B** — the spectrum walk and war stories are the best listening material; **M-F** only if the room is research-minded |
...
- Never compress: the reframe slide (5), A1 (7), the null (17), the corrections slide
  (32), the confounds ledger (34). Those five are the talk. The corpus-intro slide (6)
  is also never cut — without it the project names mean nothing to a first-time viewer.

### The interactive segment (elastic buffer)

Hand out `handout-rubric.md` printed. Two minutes silent scoring, then two discussion
axes: *where are you on the spectrum* (slide 35) and *did Step 0 stop you — and was
...
**Slide 17 · the pre-registered null.** *(The most likely fire.)*
...
**Slide 24 · the 82.2% rework contrast.**
...
**Slide 33 · closing altitude exhibit.**
...
- [ ] Each of the never-cut slides (5, 6, 7, 17, 32, 34) can be delivered from memory.
