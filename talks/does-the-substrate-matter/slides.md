...
Structure: core arc (slides 1–29, ~30 min, complete on its own) mirrors
research/eval/report/REPORT.md §§1–5, section for section. Expansion modules M-A…M-F
follow a divider slide and are pulled in as the room's appetite dictates (NOTES.md has
the branch-point map). Every number travels with its caveat ON THE SAME SLIDE — a slide
that shows an exhibit without its caveat is misquoting the report. Slide titles follow
the honest captions in report/exhibits.md and are not sharpened beyond them.
...
## A candid case study, with evidence
...
# 2 · The frame — and what the evidence did to it
